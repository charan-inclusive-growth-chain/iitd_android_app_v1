...
public class LoanDetailRejectedActivity extends AppCompatActivity {
            ...
            try {
                ...
                viewDetailsButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(LoanDetailRejectedActivity.this, LoanApplicationDetailsActivity.class);
