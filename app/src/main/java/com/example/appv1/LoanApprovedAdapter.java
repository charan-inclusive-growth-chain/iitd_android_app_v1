...
public class LoanApprovedAdapter extends ArrayAdapter<JSONObject> {
    private final List<JSONObject> loanList;

    public LoanApprovedAdapter(Context context, List<JSONObject> loanList) {
        super(context, R.layout.loan_approved_item, loanList);
